var decorativeTrays=JSON.parse(localStorage.getItem("decorative")) || []
console.log("decorativeTrays",decorativeTrays)
decorativeTrays.map(function(e){
...
var dtraymain=document.createElement("div");
dtraymain.setAttribute("class","main")
...
div3.append(rate)
pri.append(price)
dtraymain.append(img,div1,div2,div3,pri,addtocart);

document.querySelector("#container").append(dtraymain);

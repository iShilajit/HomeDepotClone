var sculpturesData=JSON.parse(localStorage.getItem("sculptures")) || []
console.log("sculpturesData",sculpturesData)
sculpturesData.map(function(e){
...
var sculmain=document.createElement("div");
sculmain.setAttribute("class","main")
...
div3.append(rate)
pri.append(price)
sculmain.append(img,div1,div2,div3,pri,addtocart);

document.querySelector("#container").append(sculmain);

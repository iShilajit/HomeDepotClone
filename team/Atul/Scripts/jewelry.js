var jewelrydata=JSON.parse(localStorage.getItem("jewelry")) || []
console.log("jewelrydata",jewelrydata)
jewelrydata.map(function(e){
...
var jewelrymain=document.createElement("div");
jewelrymain.setAttribute("class","main")
...
div3.append(rate)
pri.append(price)
jewelrymain.append(img,div1,div2,div3,pri,addtocart);

document.querySelector("#container").append(jewelrymain);

var artificialflower=JSON.parse(localStorage.getItem("flowers")) || []
console.log("artificialflower",artificialflower)
artificialflower.map(function(e){
...
var flowermain=document.createElement("div");
flowermain.setAttribute("class","main")
...
div3.append(rate)
pri.append(price)
flowermain.append(img,div1,div2,div3,pri,addtocart);

document.querySelector("#container").append(flowermain);

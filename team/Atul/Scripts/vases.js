var vasesData=JSON.parse(localStorage.getItem("vases")) || []
console.log("vasesData",vasesData)
vasesData.map(function(e){
...
var vasesmain=document.createElement("div");
vasesmain.setAttribute("class","main")
...
div3.append(rate)
pri.append(price)
vasesmain.append(img,div1,div2,div3,pri,addtocart);

document.querySelector("#container").append(vasesmain);
